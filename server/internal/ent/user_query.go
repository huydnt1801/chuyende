...
func (uq *UserQuery) QueryTrips() *TripQuery {
...
func (uq *UserQuery) WithTrips(opts ...func(*TripQuery)) *UserQuery {
	query := (&TripClient{config: uq.config}).Query()
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withTrips; query != nil {
		if err := uq.loadTrips(ctx, query, nodes,
			func(n *User) { n.Edges.Trips = []*Trip{} },
			func(n *User, e *Trip) { n.Edges.Trips = append(n.Edges.Trips, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (uq *UserQuery) loadTrips(ctx context.Context, query *TripQuery, nodes []*User, init func(*User), assign func(*User, *Trip)) error {
	...
	query.Where(predicate.Trip(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.TripsColumn), fks...))
	}))
