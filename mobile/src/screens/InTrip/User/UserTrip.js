        ...
        <View className="flex-1 flex-col">
            ...
            <ScrollView>
                <View className="px-3 py-3">
                    <Text className="font-semibold">{t("DriverInformation")}:</Text>
                    <View className="flex-row mt-2 px-2">
                        <Text className="flex-[2]">{t("Name")}:</Text>
                        <Text className="font-semibold text-right">{trip?.driver?.fullName}</Text>
                    </View>
                    <View className="flex-row px-2 mt-1 items-center">
                        ...
                        <Text className="font-semibold text-right">{trip?.driver?.phoneNumber}</Text>
                    </View>
