const className = {
    ...
    main: `flex-1 px-3 pt-20 flex-col`,
    hello: `text-2xl font-semibold`,
    login: ``,
    wrapper: `flex-row items-center mt-10 pb-1 border-b border-gray-100`,
    flag: `w-6 h-5 mr-2`,
    ...
    icon: `mx-2`,
    driver: `flex-row mt-6 justify-center`,
    enterPassword: `mt-4`
}
